package com.loganalyzer.monitor.infrastructure.adapter;

import com.loganalyzer.monitor.domain.entity.MonitorSnapshot;
import com.loganalyzer.monitor.domain.port.SystemInfoCollector;
...
public class OshiSystemInfoCollector implements SystemInfoCollector {
    ...
    private com.loganalyzer.monitor.domain.valueobject.SystemInfo collectSystemInfo() {
        ComputerSystem computerSystem = hardware.getComputerSystem();
        Runtime runtime = Runtime.getRuntime();
        
        return com.loganalyzer.monitor.domain.valueobject.SystemInfo.builder()
